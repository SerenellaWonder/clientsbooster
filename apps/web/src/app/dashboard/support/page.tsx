...
export default function VendorSupportPage() {
  ...
  async function loadTickets() {
    try {
      ...
      const res = await fetch(`${API_URL}/api/vendor/support/tickets`, {
        headers: {
    ...
    <div>
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <h1 className="mt-3 text-4xl font-black text-[#0b1220]">Ticket</h1>
          <p className="mt-3 text-lg text-[#5b667a]">
            Gestisci le richieste di assistenza del tuo negozio.
          </p>
        </div>
        ...
        <button
          ...
          className="rounded-full bg-[#25b7f3] px-5 py-3 text-sm font-semibold text-white"
        >
              ...
              >
                ...
                <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr_0.7fr]">
                  ...
                  <div className="flex flex-col justify-center gap-2">
                    ...
                    <span className="rounded-full border border-[#dbe2ee] bg-white px-3 py-1 text-xs font-bold text-[#425066] w-fit">
                      {t.status}
                    </span>
                  </div>
